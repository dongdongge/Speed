package soyouarehere.imwork.speed.app.zxing.activity;
...
import soyouarehere.imwork.speed.app.zxing.Constant;
import soyouarehere.imwork.speed.app.zxing.UriUtil;
import soyouarehere.imwork.speed.app.zxing.camera.CameraManager;
import soyouarehere.imwork.speed.app.zxing.decoding.CaptureActivityHandler;
import soyouarehere.imwork.speed.app.zxing.decoding.InactivityTimer;
import soyouarehere.imwork.speed.app.zxing.decoding.RGBLuminanceSource;
import soyouarehere.imwork.speed.app.zxing.view.ViewfinderView;
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if (isFlashOn) {
                    // 关闭闪光灯
                    btnFlash.setImageResource(R.drawable.zxing_flash_off);
                    isFlashOn = false;
                } else {
                    // 开启闪光灯
                    btnFlash.setImageResource(R.drawable.zxing_flash_on);
                    isFlashOn = true;
                }
            }catch (Exception e){
                e.printStackTrace();
